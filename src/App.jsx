...
function App() {
  ...
  return (
    <div className="min-h-screen bg-stone-100 px-4 py-8 pb-24 text-stone-950 sm:px-6 sm:pb-20 lg:px-8 print:pb-8">
      <main className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-5xl flex-col items-center gap-8">
        ...
        {withdrawalValues && (
          <div className="w-full max-w-5xl space-y-3">
            {isExampleResult && (
              <p className="inline-flex rounded-full border border-teal-200 bg-teal-50 px-3 py-1.5 text-sm font-semibold text-teal-900 print:hidden">
